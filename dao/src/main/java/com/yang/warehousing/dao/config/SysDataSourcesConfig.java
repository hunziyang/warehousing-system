package com.yang.warehousing.dao.config;
...
@Configuration
@MapperScan(basePackages = "com.yang.warehousing.dao.mapper", sqlSessionTemplateRef = "sysSqlSessionTemplate")
public class SysDataSourcesConfig {
